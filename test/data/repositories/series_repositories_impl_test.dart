...
import 'package:moris/common/exception.dart';
import 'package:moris/common/failure.dart';
import 'package:moris/data/models/genre_model.dart';
import 'package:moris/data/models/series_detail_model.dart';
...
void main() {
  ...
  group('save watchlist', () {
    test('should return success message when saving successful', () async {
      ...
      when(mockLocalDataSource
              .insertWatchlist(SeriesTable.fromEntity(testSeriesDetail)))
  ...
  group('remove watchlist', () {
    test('should return success message when remove successful', () async {
      // arrange
      when(mockLocalDataSource
              .removeWatchlist(SeriesTable.fromEntity(testSeriesDetail)))
